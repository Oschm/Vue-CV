...
const isLoaded = () => {
  return (
    loadStatus.value === constants.LoadStatus.LOADED ||
    loadStatus.value === constants.LoadStatus.ERROR
  );
};
...
const _onSourceChanged = () => {
  _setLoadStatus(
    typeof props.src !== "string"
      ? constants.LoadStatus.ERROR
      : constants.LoadStatus.LOADING
  );
};
