  ...
  <SectionTemplate :section-data="props.sectionData">
    ...
    <ul class="timeline">
      ...
      <li v-for="item in orderedItems" class="timeline-item">
        ...
        <div
          :class="{
            'timeline-item-logo-round': isRound(item['place']['IsLogoRound']),
            'timeline-item-logo': !isRound(item['place']['IsLogoRound']),
          }"
        >
          ...
          <ImageView
            ...
            class="timeline-item-img img-fluid"
            :class="{ 'rounded-circle': isRound(item['place']['IsLogoRound']) }"
          />
          ...
          <div class="timeline-item-content-header">
            ...
            <div class="flex-column-title">
              ...
              <h6 class="timeline-item-subtitle text-light-6 text-3">
                ...
                <span>{{
                  item["place"] && item["place"]["locales"]
                    ? item["place"]["locales"]["name"]
                    : ""
                }}</span>
              </h6>
            </div>
